  ...
  return (
    <>
      {messageId ? (
        <div className="chatArea">
          ...
          <div className="chatBody">
            <div className="dayRow">
              <div className="day">Monday, 28th August</div>
            </div>
            <div className="myrow">
              <div className="mymessagebody">
                <p>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Quidem incidunt, distinctio amet non repellat doloribus modi
                  voluptates ullam? Praesentium maiores expedita minima! Debitis
                  omnis nostrum quod saepe, cum deserunt suscipit?
                </p>
        ...
        >
          <div>Select A channel and start talking</div>
        </div>
      )}
    </>
  );
